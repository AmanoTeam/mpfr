...
__MPFR_DECLSPEC int mpfr_hermite (mpfr_ptr, long, mpfr_srcptr, mpfr_rnd_t);
__MPFR_DECLSPEC int mpfr_legendre (mpfr_ptr, long, mpfr_srcptr, mpfr_rnd_t);
__MPFR_DECLSPEC int mpfr_lambertw0 (mpfr_ptr, mpfr_srcptr, mpfr_rnd_t);
__MPFR_DECLSPEC int mpfr_lambertwm1 (mpfr_ptr, mpfr_srcptr, mpfr_rnd_t);
