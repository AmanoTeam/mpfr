...
%
% TODO: improve description of lambert w
%

\subsection{The LambertW function}

The LambertW function $W(x)$ is defined as the inverse of the mapping
$W(x) = xe^x$. $W(x)$ is a complex multivalued function that has two
real branches: the principal one $W_0$, defined for $x \ge -1/e$, and
$W_{-1}$, defined for $-1/e \le x < 0$ (see
Figure~\ref{fig:lambertw}). The two branches meet at the point $x =
-1/e$, where $W_0(-1/e) = W_{-1}(-1/e) = -1$, and for $x < -1/e$ the
function is not defined over the reals.

\begin{figure}[htp]
\centering
\includegraphics[width=.9\textwidth]{lambert_w_plot.pdf}
\caption{The two real branches of the LambertW function: the principal branch
$W_0$ (defined for $x \ge -1/e$) and the branch $W_{-1}$ (defined for
$-1/e \le x < 0$). Both branches meet at $(-1/e, -1)$; $W_0(-1/e) = W_{-1}(-1/e)
= -1$.}
\label{fig:lambertw}
\end{figure}
...
Starting from $-0.3$, the width of each interval $w_k$ is calculated
by the geometric progression $w_k = 0.2 * j^k$, with $j =
3.536298222377439$, where the value of $j$ is chosen empirically to
guarantee the error for $|W_0(x) - P_k(x)| < 10^{-5}$ for each $w_k$.

\begin{table}[htp]
\begin{tabular}{cccc}
a           & b            & $|W_0(x)-P(x)|$ \\[0.05cm]
\hline
-0.36       & -0.35        & 6.3398e-09      \\[0.05cm]
-0.35       & -0.28321206  & 2.9263e-06      \\[0.05cm]
-0.3        & -0.1         & 1.8725e-06      \\[0.05cm]
-0.1        & 0.60725964   & 2.0653e-06      \\[0.05cm]
0.60725964  & 3.1083407    & 3.0241e-06      \\[0.05cm]
3.1083407   & 11.952909    & 4.3717e-06      \\[0.05cm]
11.952909   & 43.22994     & 5.7751e-06      \\[0.05cm]
43.22994    & 153.83485    & 6.9773e-06      \\[0.05cm]
153.83485   & 544.9668     & 7.8947e-06      \\[0.05cm]
544.9668    & 1928.126     & 8.5598e-06      \\[0.05cm]
1928.126    & 6819.3895    & 9.0376e-06      \\[0.05cm]
6819.3895   & 24116.356    & 9.3856e-06      \\[0.05cm]
24116.356   & 85283.587    & 9.6453e-06      \\[0.05cm]
85283.587   & 301589.16    & 9.8441e-06      \\[0.05cm]
301589.16   & 1066510.2    & 9.9999e-06      \\[0.05cm]
\hline
\end{tabular}
\caption{In this table are presented all the ranges $[a,b]$ that we
  used to calculate the initial guess. For each of them we report the
  maximum error $|W_0(x)-P(x)|$, where $P(x)$ is the polynomial chosen
to approximate the function in $[a,b]$.}
\label{table:lambertw}
\end{table}
