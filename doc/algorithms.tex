...
\subsection{Hash}
MPFR provides a set of APIs to compute a 32-bit hash value of an MPFR number.
Those functions implement a \textit{non-cryptographic} hash function, based on the
Fowler-Noll-Vo function (from now on FNV), as you can see in Algorithm \ref{algo:fnv32}.
For further information and theoretical details, refer to \cite{fnv-17}.
